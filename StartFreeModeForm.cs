...
{
    public partial class StartFreeModeForm : Form
    {
        private string connectionString;
        private MainForm mainForm;

        public StartFreeModeForm(string connectionString, MainForm mainForm)
        {
            InitializeComponent();
        ...
        private void btnNormal_Click(object sender, EventArgs e)
        {
            ...
            var quizInterfaceForm = new QuizInterfaceForm("normal", connectionString, true, mainForm);
        ...
        {
            this.Hide(); // Hide the current form
            var quizInterfaceForm = new QuizInterfaceForm("hell", connectionString, true, mainForm);
            quizInterfaceForm.ShowDialog();
            this.Close(); // Close the current form after quiz interface form is closed
        }
